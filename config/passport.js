...
function getExpireDate(days) {
	...
	var td = moment().add('days', trialPeriodDays).format("YYYY-MM-DD HH:mm:ss");;
				...
				console.log('local-signup');	
				 users.getUserByUserName(UserName, Password, function(err, user) {
					...
					if (user) {
						...
						users.createUser(ipAddress, newUserMysql.UserName,newUserMysql.Email,newUserMysql.Password,AccountType,IsActive,role,licType,licExpire, function(err, user) {
							// req.user = user; 
							return done(null, user);
						});
					}
