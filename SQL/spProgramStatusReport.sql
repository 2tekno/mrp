IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.spProgramStatusReport'))
   exec('CREATE PROCEDURE [dbo].[spProgramStatusReport] AS BEGIN SET NOCOUNT ON; END')
GO

ALTER PROC spProgramStatusReport
...
exec spProgramStatusReport 
exec spProgramStatusReport '1,3', NULL
exec spProgramStatusReport NULL, '4'
exec spProgramStatusReport '2', '4'
